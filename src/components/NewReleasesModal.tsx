...
const query = graphql`
  ...
  {
    song: file(relativePath: { eq: "images/releases/wewontspeaklikethisagain.jpg" }) {
      ...Image_file
    }
    beat: file(relativePath: { eq: "images/releases/pureimagination.jpg" }) {
      ...Image_file
    }
  }
`;
...
const data = {
  song: {
    url:
      "https://distrokid.com/hyperfollow/sadlilblackboy/we-wont-speak-like-this-again "
  },
  beat: {
        ...
        <div className="flex w-72 h-72 sm:w-2/3 md:w-1/2 sm:h-1/2 bg-white shadow-2xl rounded-lg flex-col relative p-4 border-4 border-black">
          <div className="flex min-h-0 flex-1 space-x-0.5">
            <a
              ...
              href={data.song.url}
            >
              <h3>[we won't speak like this agin]</h3>
              <Image
