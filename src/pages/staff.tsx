...
const staff = [
  {
    imgName: "Quentin",
    name: "Quentin",
    title: "Head Creator. Multi-instrumentalist. Rapper. Singing nigga.",
  ...
  },
  {
    imgName: "Ethan",
    name: "Ethan",
    title: "Head Illustrator. Art student. Reformed farm boy.",
    social: "@ej.arts._",
