...
export default ({ data }) => (
  <Layout>
    <Page>
      ...
      <Body>
        <ReleaseFrame>
          <ImgContainer href="https://distrokid.com/hyperfollow/sadlilblackboy/are-we-fine">
            <Img fluid={data.singleRelease.childImageSharp.fluid} />
          </ImgContainer>
        </ReleaseFrame>
        <ReleaseFrame>
          <ImgContainer href="https://distrokid.com/hyperfollow/nuq/its-just-us-now">
...
export const query = graphql`
  {
    beatRelease: file(relativePath: { eq: "justus.PNG" }) {
      childImageSharp {
        fluid(maxWidth: 1024) {
    ...
    singleRelease: file(relativePath: { eq: "arewefine.PNG" }) {
      childImageSharp {
        fluid(maxWidth: 1024) {
          ...GatsbyImageSharpFluid_withWebp_tracedSVG
        }
