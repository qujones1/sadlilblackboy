...
export default ({ data }) => (
  <Layout>
    <Page>
      ...
      <Body>
        <ReleaseFrame>
          <ImgContainer href="https://distrokid.com/hyperfollow/sadlilblackboy/kaleidoscope-feat-nuq">
            <Img fluid={data.singleRelease.childImageSharp.fluid} />
          </ImgContainer>
        </ReleaseFrame>
        <ReleaseFrame>
          <ImgContainer href="https://distrokid.com/hyperfollow/nuq/lets-go-smoke-in-the-bathroom">
...
export const query = graphql`
  {
    beatRelease: file(relativePath: { eq: "smoke.PNG" }) {
      childImageSharp {
        fluid(maxWidth: 1024) {
    ...
    singleRelease: file(relativePath: { eq: "kaliedoscope.PNG" }) {
      childImageSharp {
        fluid(maxWidth: 1024) {
          ...GatsbyImageSharpFluid_withWebp_tracedSVG
        }
